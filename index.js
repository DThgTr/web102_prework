...
let displayStr = 
`
A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length}.
${(unfunded > 0) ? ("Currently, " + unfunded + " remains unfunded. We need your help to fund these amazing games!") : ""} 
`
